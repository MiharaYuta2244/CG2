...
void DirectXCommon::CreateRootSignatureObject3d() {
...
void DirectXCommon::CreateRootSignatureParticle() {
	HRESULT hr;
	...
	rootParameters[0].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;                             // PixelShaderで使う
	rootParameters[0].Descriptor.ShaderRegister = 0;                                                // レジスタ番号0とバインド
	rootParameters[1].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;                   // DiscriptorTableを使う
	rootParameters[1].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;                            // VertexShaderで使う
...
void DirectXCommon::CreateGraphicsPipelineObject3d() {
	HRESULT hr;
...
void DirectXCommon::CreateGraphicsPipelineParticle() {
	HRESULT hr;
	...
	D3D12_CPU_DESCRIPTOR_HANDLE instancingSrvHandleCPU = GetCPUDescriptorHandle(srvDescriptorHeap_, descriptorSizeSRV_, 3);
	D3D12_GPU_DESCRIPTOR_HANDLE instancingSrvHandleGPU = GetGPUDescriptorHandle(srvDescriptorHeap_, descriptorSizeSRV_, 3);
